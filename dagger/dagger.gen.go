...
// GhGetOpts contains options for Gh.Get
type GhGetOpts struct {
	//
...
func (r *Gh) Get(opts ...GhGetOpts) *File {
...
func (r *Gh) Run(ctx context.Context, token *Secret, cmd string, opts ...GhRunOpts) (string, error) {
